...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			...
			if data.current.value == 'agent_wear' and PlayerData.job.grade_name == 'agent' then --Ajout de tenue par grades
			...
			if data.current.value == 'lieutenant_wear' and PlayerData.job.grade_name == 'detective' then --Ajout de tenue par grades
			...
			if data.current.value == 'captain_wear' and  PlayerData.job.grade_name == 'captain' then --Ajout de tenue par grades
