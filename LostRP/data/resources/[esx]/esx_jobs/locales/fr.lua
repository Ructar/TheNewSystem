Locales['fr'] = {
  ...
  -- Lumber Jack job
  ['lj_locker_room']            = "Hall des Bucherons",
  ...
  -- Fisherman
  ['fm_fish_locker']            = "Hall des Pêcheurs",
  ['fm_fish']                   = 'poisson',
  ...
  -- Fuel
  ['f_oil_refiner']             = 'Hall des Raffineurs',
  ['f_drill_oil']               = 'forage de pétrol',
  ['f_fuel']                    = 'pétrol',
  ['f_drillbutton']             = 'appuyez sur ~INPUT_PICKUP~ pour forer.',
  ['f_fuel_refine']             = 'pétrol raffiné',
  ['f_refine_fuel_button']      = 'appuyez sur ~ INPUT_PICKUP ~ pour refiner.',
  ...
  -- Miner
  ['m_miner_locker']            = "Hall des Mineurs ",
  ['m_rock']                    = 'rocher',
  ...
  -- Slaughterer
  ['s_slaughter_locker']        = "Hall des Abatteurs",
  ['s_hen']                     = 'poulailler',
  ...
  -- Dress Designer
  ['dd_dress_locker']           = "Hall des Couturiers",
  ['dd_wool']                   = 'laine',
