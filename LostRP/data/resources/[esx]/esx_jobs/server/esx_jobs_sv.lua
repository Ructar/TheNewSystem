...
AddEventHandler('esx_jobs:caution', function(cautionType, cautionAmount, spawnPoint, vehicle, SpawnPointVehicleBusy)
  local source = source
  local xPlayer = ESX.GetPlayerFromId(source)
  if cautionType == "take" and SpawnPointVehicleBusy == false then
