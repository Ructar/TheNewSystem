...
Citizen.CreateThread( function()
	while true do
		...
		if ( IsControlJustReleased( 0, 56 ) or IsDisabledControlJustReleased( 0, 56 ) ) and GetLastInputMethod( 0 ) and not IsPauseMenuActive() and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f9
		...
		if ( IsControlJustReleased( 0, 57 ) or IsDisabledControlJustReleased( 0, 57 ) ) and GetLastInputMethod( 0 ) and not blockinput and ((settings["adminOnlyTrainer"] == true and adminStatus == true) or settings["adminOnlyTrainer"] == false) then -- f10
			teleportToWaypoint()
		end

		if ( IsControlJustReleased( 0, 84 ) or IsDisabledControlJustReleased( 0, 84 ) ) and GetLastInputMethod( 0 ) and ((settings["adminOnlyNoclip"] == true and adminStatus == true) or settings["adminOnlyNoclip"] == false) then
			toggleNoClipMode()
		end
